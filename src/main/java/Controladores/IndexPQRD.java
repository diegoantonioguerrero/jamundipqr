...
public class IndexPQRD {
	...
	private static String textEncabezadoEntrada;
	...
	public IndexPQRD() {
		try {
			...
			textEncabezadoEntrada = Util.getProperties("textEncabezadoEntrada");
		} catch (Exception var2) {
			Logger.getLogger(IndexPQRD.class.getName()).log(Level.SEVERE, (String) null, var2);
		}
		/*
		 * try { Util.sendMailTest(); } catch (Exception var19) {
		 * System.out.println(var19);
		 * Logger.getLogger(FormularPQRD.class.getName()).log(Level.SEVERE,
		 * (String)null, var19); }
		 */
	...
	public String getTextEncabezadoEntrada() {
		return textEncabezadoEntrada;
	}
